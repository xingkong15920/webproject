    ...
    function echarts_3() {
        ...
        var option = {
            ...
            series: [{
                ...
                data: [21232200, 21221466, 33112257, 31245580, 31232207, 41221200, 41215512, 45134220, 48251215, 49123280, 50331250, 52242187]
            }, {
                name: '交易笔数',
                type: 'line',
                smooth: true,
                ...
                data: [131400, 113300, 125230, 143450, 123250, 164650, 125720, 221800, 182420, 193310, 131244, 155300]
            }]
        };
            ...
            "series": [
                {
                    "name": "总交易额",
                    "type": "bar",
                    "data": ["3131458.20", "5123586.25", "5312310.47", "4883435.21", "4193278.23"],
                    markPoint: {
                        data: [
                            {type: 'max', name: '最大值'},
                            {type: 'min', name: '最小值'}
