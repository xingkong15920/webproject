...
function() {
	...
	C.prototype = [], C.prototype.constructor = C, w.extend = function() {
		...
		e.remove(T.thisElemDate), a ? t.elem.append(i) : (document.body.appendChild(i), e.position()), e.cDate().calendar(), e.changeEvent(), T.thisElemDate = e.elemID, "function" == typeof t.ready && t.ready(w.extend({}, t.dateTime, {
			month: t.dateTime.month + 1
		}))
	}, T.prototype.remove = function(e) {
		var t = this,
			n = (t.config, w("#" + (e || t.elemID)));
		return n.hasClass(c) || t.cDate(function() {
			n.remove()
		}), t
		...
		if (y && h.removeChild(y), h.appendChild(d), "year" === e || "month" === e) w(n.elemMain[t]).addClass("laydate-ym-show"), w(d).find("li").on("click", function() {
			...
			if (!w(this).hasClass(s)) {
				...
				"year" === a.type || "month" === a.type ? (w(d).find("." + o).removeClass(o), w(this).addClass(o), "month" === a.type && "year" === e && (n.listYM[t][0] = r, l && (n[["startDate", "endDate"][t]].year = r), n.list("month", t))) : (n.cDate("limit").calendar(), n.closeList()), n.setBtnStatus(), a.range || n.done(null, "change"), w(n.footer).find(D).removeClass(s)
			}
		});
		else {
			var S = w.elem("span", {
		...
		return {
			prevYear: function() {
				s("sub") || (a.year--, t.cDate("limit").calendar(), n.range || t.done(null, "change"))
			},
			prevMonth: function() {
				...
				w.extend(a, {
					year: e[0],
					month: e[1]
				}), t.cDate("limit").calendar(), n.range || t.done(null, "change")
			},
			nextMonth: function() {
			...
			nextYear: function() {
				s() || (a.year++, t.cDate("limit").calendar(), n.range || t.done(null, "change"))
			}
		}
...
function(e, t) {
	...
	function m(e) {
		Be.test(e.type) && (e.defaultced = e.ced)
	}
	function y(e, t, n, r, i) {
		...
		for (u && y.removeChild(u), fe.appendced || pe.grep(h(v, "input"), m), x = 0; a = v[x++];) if (r && pe.inArray(a, r) > -1) i && i.push(a);
	...
	function k(e, t) {
		...
		if (1 === t.nodeType) {
			...
			"script" === n && t.text !== e.text ? (C(t).text = e.text, E(t)) : "object" === n ? (t.parentNode && (t.outerHTML = e.outerHTML), fe.html5Clone && e.innerHTML && !pe.trim(t.innerHTML) && (t.innerHTML = e.innerHTML)) : "input" === n && Be.test(e.type) ? (t.defaultced = t.ced = e.ced, t.value !== e.value && (t.value = e.value)) : "option" === n ? t.defaultSelected = t.selected = e.defaultSelected : "input" !== n && "textarea" !== n || (t.defaultValue = e.defaultValue)
		}
	}
	function S(e, t, n, r) {
		t = oe.apply([], t);
		var i, o, a, s, u, l, c = 0,
			...
			p = t[0],
			g = pe.isFunction(p);
		if (g || f > 1 && "string" == typeof p && !fe.cClone && rt.test(p)) return e.each(function(i) {
			var o = e.eq(i);
	...
	var ve = function(e) {
			...
			var b, w, T, C, E, N, k, S, A, D, j, L, H, q, _, F, M, O, R, P = "sizzle" + 1 * new Date,
				...
				te = "ced|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",
				ne = "[\\x20\\t\\r\\n\\f]",
				re = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+",
			...
			w = t.support = {}, E = t.isXML = function(e) {
				...
				function(e, t) {
					...
					q.appendChild(e).innerHTML = "<a id='" + P + "'></a><select id='" + P + "-\r\\' msallowcapture=''><option selected=''></option></select>", e.querySelectorAll("[msallowcapture^='']").length && F.push("[*^$]=" + ne + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || F.push("\\[" + ne + "*(?:value|" + te + ")"), e.querySelectorAll("[id~=" + P + "-]").length || F.push("~="), e.querySelectorAll(":ced").length || F.push(":ced"), e.querySelectorAll("a#" + P + "+*").length || F.push(".#.+[+~]")
				}), i(function(e) {
				...
				pseudos: {
					...
					ced: function(e) {
						...
						return "input" === t && !! e.ced || "option" === t && !! e.selected
					},
					selected: function(e) {
	...
	function() {
		...
		e.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='c1'/>", fe.leadingWhitespace = 3 === e.firstChild.nodeType, fe.tbody = !e.getElementsByTagName("tbody").length, fe.htmlSerialize = !! e.getElementsByTagName("link").length, fe.html5Clone = "<:nav></:nav>" !== re.createElement("nav").cloneNode(!0).outerHTML, n.type = "c1", n.ced = !0, t.appendChild(n), fe.appendced = n.ced, e.innerHTML = "<textarea>x</textarea>", fe.noCloneced = !! e.cloneNode(!0).lastChild.defaultValue, t.appendChild(e), n = re.createElement("input"), n.setAttribute("type", "radio"), n.setAttribute("ced", "ced"), n.setAttribute("name", "t"), e.appendChild(n), fe.cClone = e.cloneNode(!0).cloneNode(!0).lastChild.ced, fe.noCloneEvent = !! e.addEventListener, e[pe.expando] = 1, fe.attributes = !e.getAttribute(pe.expando)
	}();
	var Xe = {
	...
	pe.event = {
		...
		special: {
			...
			click: {
				trigger: function() {
					if (pe.nodeName(this, "input") && "c1" === this.type && this.click) return this.click(), !1
				},
				_default: function(e) {
	...
	function(e, t, n) {
		...
		setup: function() {
			return Ye.test(this.nodeName) ? ("c1" !== this.type && "radio" !== this.type || (pe.event.add(this, "propertychange._change", function(e) {
				"ced" === e.originalEvent.propertyName && (this._justChanged = !0)
		...
		handle: function(e) {
			var t = e.target;
			if (this !== t || e.isSimulated || e.isTrigger || "radio" !== t.type && "c1" !== t.type) return e.handleObj.handler.apply(this, arguments)
		},
		teardown: function() {
	...
	pe.extend({
		...
		clone: function(e, t, n) {
			...
			if (fe.html5Clone || pe.isXMLDoc(e) || !et.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (st.innerHTML = e.outerHTML, st.removeChild(o = st.firstChild)), !(fe.noCloneEvent && fe.noCloneced || 1 !== e.nodeType && 11 !== e.nodeType || pe.isXMLDoc(e))) for (r = h(o), s = h(e), a = 0; null != (i = s[a]); ++a) r[a] && k(i, r[a]);
	...
	pe.Animation = pe.extend($, {
		...
		n = re.createElement("div"), n.setAttribute("className", "t"), n.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='c1'/>", e = n.getElementsByTagName("a")[0], t.setAttribute("type", "c1"), n.appendChild(t), e = n.getElementsByTagName("a")[0], e.style.cssText = "top:1px", fe.getSetAttribute = "t" !== n.className, fe.style = /top/.test(e.getAttribute("style")), fe.hrefNormalized = "/a" === e.getAttribute("href"), fe.cOn = !! t.value, fe.optSelected = i.selected, fe.enctype = !! re.createElement("form").enctype, r.disabled = !0, fe.optDisabled = !i.disabled, t = re.createElement("input"), t.setAttribute("value", ""), fe.input = "" === t.getAttribute("value"), t.value = "t", t.setAttribute("type", "radio"), fe.radioValue = "t" === t.value
	}();
	var Dt = /\r/g,
		jt = /[\x20\t\r\n\f]+/g;
	pe.fn.extend({
	...
	}), pe.each(["radio", "c1"], function() {
		pe.valHooks[this] = {
			set: function(e, t) {
				if (pe.isArray(t)) return e.ced = pe.inArray(pe(e).val(), t) > -1
			}
		}, fe.cOn || (pe.valHooks[this].get = function(e) {
	...
	pe.param = function(e, t) {
		...
		serializeArray: function() {
			return this.map(function() {
				...
				var e = this.type;
				return this.name && !pe(this).is(":disabled") && sn.test(this.nodeName) && !an.test(e) && (this.ced || !Be.test(e))
			}).map(function(e, t) {
				var n = pe(this).val();
	...
	u.prototype.set = function(e) {
		...
		var n = this,
			...
			d = {
				...
				c1: function() {
					var e = {
						c1: ["layui-form-c1", "layui-form-ced", "c1"],
						_switch: ["layui-form-switch", "layui-form-onswitch", "switch"]
					},
						t = u.find("input[type=c1]"),
						a = function(e, t) {
							var a = i(this);
							e.on("click", function() {
								var i = a.attr("lay-filter"),
									n = (a.attr("lay-text") || "").split("|");
								a[0].disabled || (a[0].ced ? (a[0].ced = !1, e.removeClass(t[1]).find("em").text(n[1])) : (a[0].ced = !0, e.addClass(t[1]).find("em").text(n[0])), layui.event.call(a[0], l, t[2] + "(" + i + ")", {
									elem: a[0],
									value: a[0].value,
									othis: e
								}))
					...
					t.each(function(t, n) {
						...
						var d = l.next("." + u[0]),
							f = i(['<div class="layui-unselect ' + u[0] + (n.ced ? " " + u[1] : "") + (o ? " layui-c1-disbaled " + c : "") + '" lay-skin="' + (r || "") + '">',
							{
								_switch: "<em>" + ((n.ced ? s[0] : s[1]) || "") + "</em><i></i>"
				...
				radio: function() {
						...
						n = function(a) {
							...
							a.on("click", function() {
								...
								n[0].disabled || (layui.each(d, function() {
									var a = i(this).next("." + e);
									this.ced = !1, a.removeClass(e + "ed"), a.find(".layui-icon").removeClass(s).html(t[1])
								}), n[0].ced = !0, a.addClass(e + "ed"), a.find(".layui-icon").addClass(s).html(t[0]), layui.event.call(n[0], l, "radio(" + u + ")", {
									elem: n[0],
									value: n[0].value,
									othis: a
								}))
					...
					a.each(function(a, l) {
						var r = i(this),
							...
							o = this.disabled;
						if ("string" == typeof r.attr("lay-ignore")) return r.show();
						var u = i(['<div class="layui-unselect ' + e + (l.ced ? " " + e + "ed" : "") + (o ? " layui-radio-disbaled " + c : "") + '">', '<i class="layui-anim layui-icon">' + t[l.ced ? 0 : 1] + "</i>", "<span>" + (l.title || "未命名") + "</span>", "</div>"].join(""));
	...
	var d = function() {
				...
				if (r.removeClass(o), layui.each(c, function(e, i) {
					...
					if (a[i]) {
						...
						if (f = f || a[i][1], c) return "tips" === u ? t.tips(f, function() {
							return "string" == typeof r.attr("lay-ignore") || "select" !== l.tagName.toLowerCase() && !/^c1|radio$/.test(l.type) ? r : r.next()
						}(), {
							tips: 1
						}) : "alert" === u ? t.alert(f, {
							title: "提示",
			...
			return layui.each(v, function(e, i) {
				if (i.name = (i.name || "").replace(/^\s*|\s*&/, ""), i.name) {
					...
					/^c1|radio$/.test(i.type) && !i.ced || (c[i.name] = i.value)
				}
		...
		layui.each(n, function(a, n) {
			var l = n.children && n.children.length > 0,
				...
				s = o(["<li " + (n.spread ? 'data-spread="' + n.spread + '"' : "") + ">", function() {
					...
					return r.c ? '<i class="layui-icon layui-tree-c">' + ("c1" === r.c ? t.c1[0] : "radio" === r.c ? t.radio[0] : "") + "</i>" : ""
				}(), function() {
...
layui.define(["laytpl", "laypage", "layer", "form"], function(e) {
	...
	var t = layui.$,
		...
		W = function(e) {
			...
			}(), '<th data-field="{{ item2.field||i2 }}" {{# if(item2.minWidth){ }}data-minwidth="{{item2.minWidth}}"{{# } }} ' + t + ' {{# if(item2.unresize){ }}data-unresize="true"{{# } }}>', '<div class="layui-table-cell laytable-cell-', "{{# if(item2.colspan > 1){ }}", "group", "{{# } else { }}", "{{d.index}}-{{item2.field || i2}}", '{{# if(item2.type !== "normal"){ }}', " laytable-cell-{{ item2.type }}", "{{# } }}", "{{# } }}", '" {{#if(item2.align){}}align="{{item2.align}}"{{#}}}>', '{{# if(item2.type === "c1"){ }}', '<input type="c1" name="layTablec1" lay-skin="primary" lay-filter="layTableAllChoose" {{# if(item2[d.data.cName]){ }}ced{{# }; }}>', "{{# } else { }}", '<span>{{item2.title||""}}</span>', "{{# if(!(item2.colspan > 1) && item2.sort){ }}", '<span class="layui-table-sort layui-inline"><i class="layui-edge layui-table-sort-asc"></i><i class="layui-edge layui-table-sort-desc"></i></span>', "{{# } }}", "{{# } }}", "</div>", "</th>", e.fixed ? "{{# }; }}" : "", "{{# }); }}", "</tr>", "{{# }); }}", "</thead>", "</table>"].join("")
		},
	...
	S.prototype.config = {
		...
		e.c1 && (e.type = "c1"), e.space && (e.type = "space"), e.type || (e.type = "normal"), "normal" !== e.type && (e.unresize = !0, e.width = e.width || i[e.type])
		...
		var c = this,
			...
			m = function() {
					...
					0 !== a.length && (r || (a[d.config.indexName] = e), c.eachCols(function(e, n) {
						...
						if (void 0 !== h && null !== h || (h = ""), !(n.colspan > 1)) {
							...
							function() {
								...
								return "c1" === n.type ? '<input type="c1" name="layTablec1" lay-skin="primary" ' +
								function() {
									var t = d.config.cName;
									return n[t] ? (a[t] = n[t], n[t] ? "ced" : "") : e[t] ? "ced" : ""
				...
				}), c.layBody.scrollTop(0), c.layMain.find("." + f).remove(), c.layMain.find("tbody").html(h.join("")), c.layFixLeft.find("tbody").html(y.join("")), c.layFixRight.find("tbody").html(p.join("")), c.renderForm(), c.synccAll(), c.haveInit ? c.scrollPatch() : setTimeout(function() {
					c.scrollPatch()
	...
	}, S.prototype.setcData = function(e, t) {
		var i = this,
			a = i.config,
			l = d.cache[i.key];
		l[e] && l[e].constructor !== Array && (l[e][a.cName] = t)
	}, S.prototype.synccAll = function() {
		var e = this,
			t = e.config,
			i = e.layHeader.find('input[name="layTablec1"]'),
			a = function(i) {
				return e.eachCols(function(e, a) {
					"c1" === a.type && (a[t.cName] = i)
				}), i
			};
		i[0] && (d.cStatus(e.key).isAll ? (i[0].ced || (i.prop("ced", !0), e.renderForm("c1")), a(!0)) : (i[0].ced && (i.prop("ced", !1), e.renderForm("c1")), a(!1)))
		...
		u.on("mousemove", function(e) {
		...
		}), a.elem.on("click", 'input[name="layTablec1"]+', function() {
			var e = t(this).prev(),
				i = a.layBody.find('input[name="layTablec1"]'),
				l = e.parents("tr").eq(0).data("index"),
				n = e[0].ced,
				o = "layTableAllChoose" === e.attr("lay-filter");
			o ? (i.each(function(e, t) {
				t.ced = n, a.setcData(e, n)
			}), a.synccAll(), a.renderForm("c1")) : (a.setcData(l, n), a.synccAll()), layui.event.call(this, s, "c1(" + f + ")", {
				ced: n,
			...
			} else o.find(".layui-form-switch,.layui-form-c1")[0] || Math.round(o.prop("scrollWidth")) > Math.round(o.outerWidth()) && (a.tipsIndex = l.tips(['<div class="layui-table-tips-main" style="margin-top: -' + (o.height() + 16) + "px;" +
			function() {
	...
	}, d.cStatus = function(e) {
		var t = 0,
			i = 0,
			a = [],
			l = d.cache[e] || [];
		return layui.each(l, function(e, l) {
			return l.constructor === Array ? void i++ : void(l[d.config.cName] && (t++, a.push(d.clearCacheKey(l))))
		}), {
			data: a,
		...
		return e = t.extend({}, e), delete e[d.config.cName], delete e[d.config.indexName], e
	}, d.init(), e(s, d)
});
layui.define("jquery", function(e) {
	"use strict";
		...
		b = function(t, e) {
			var l = this,
				n = i.open({
					...
					title: "超链接",
					skin: "layui-layer-msg",
					content: ['<ul class="layui-form" style="margin: 15px;">', '<li class="layui-form-item">', '<label class="layui-form-label" style="width: 60px;">URL</label>', '<div class="layui-input-block" style="margin-left: 90px">', '<input name="url" lay-verify="url" value="' + (t.href || "") + '" autofocus="true" autocomplete="off" class="layui-input">', "</div>", "</li>", '<li class="layui-form-item">', '<label class="layui-form-label" style="width: 60px;">打开方式</label>', '<div class="layui-input-block" style="margin-left: 90px">', '<input type="radio" name="target" value="_self" class="layui-input" title="当前窗口"' + ("_self" !== t.target && t.target ? "" : "ced") + ">", '<input type="radio" name="target" value="_blank" class="layui-input" title="新窗口" ' + ("_blank" === t.target ? "ced" : "") + ">", "</div>", "</li>", '<li class="layui-form-item" style="text-align: center;">', '<button type="button" lay-submit lay-filter="layedit-link-yes" class="layui-btn"> 确定 </button>', '<button style="margin-left: 20px;" type="button" class="layui-btn layui-btn-primary"> 取消 </button>', "</li>", "</ul>"].join(""),
