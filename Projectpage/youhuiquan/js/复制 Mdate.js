	...
	Mdate.prototype = {
		...
		dateSure: function() {
			...
			sureBtn.onclick = function() {
				if (that.format == "YMD") {
					that.acceptId.innerHTML = yearTag + "-" + monthTag + "-" + dayTag
				} else {
					that.acceptId.innerHTML = yearTag + that.format + that.dateForTen(monthTag) + that.format + that.dateForTen(dayTag)
				}
